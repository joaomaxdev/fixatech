...
export default function Header() {
    return (
        <header className='flex shadow-md sm:px-10 px-6 py-3 bg-white font-[sans-serif] min-h-[70px]'>
            <div className="flex w-full max-w-screen-xl mx-auto">
                <div
                    ...
                    <div className='flex items-center space-x-4 max-md:ml-auto'>
                        <button type="button" className="border-none outline-none flex items-center justify-center rounded-full p-2 hover:bg-gray-100 transition-all">
                ...
                <div id="collapseMenu"
                    ...
                    <button id="toggleClose" className='fixed top-2 right-4 z-[100] rounded-full bg-white w-9 h-9 flex items-center justify-center border'>
                    ...
                    <ul
                        ...
                        <li className='border-b py-3 px-3'>
                            <a href='javascript:void(0)' className='hover:text-[#007bff] text-[#007bff] block font-semibold text-base'>Home</a>
                        </li>
